...
insert into metrics(times_shared, times_visited, lecture_id) VALUES (10, 1000, 1);

insert into lecture(status, type, created_at, starts_at, ends_at, organizer_id, address, description, lecturer, title, url) values ('IN_PROGRESS', 'ONLINE', utc_timestamp, '2024-09-01 03:00:00', '2024-09-01 23:00:00', 1, null, 'Palestra em Andamento', 'Jonkler da Silva', 'Palestra de tecnologia', 'https://teste.com');
insert into metrics(times_shared, times_visited, lecture_id) VALUES (20, 20, 2);

insert into lecture(status, type, created_at, starts_at, ends_at, organizer_id, address, description, lecturer, title, url) values ('COMPLETED', 'ONLINE', utc_timestamp, '2024-09-01 03:00:00', '2024-09-01 23:00:00', 1, null, 'Palestra Finalizada', 'Wang da Silva', 'Palestra de geografia', 'https://teste.com');
insert into metrics(times_shared, times_visited, lecture_id) VALUES (5, 5, 3);

insert into lecture(status, type, created_at, starts_at, ends_at, organizer_id, address, description, lecturer, title, url) values ('CANCELED', 'ONLINE', utc_timestamp, '2024-09-01 03:00:00', '2024-09-01 23:00:00', 1, null, 'Palestra Cancelada', 'NickDusk da Silva', 'Palestra de inglês', 'https://teste.com');
insert into metrics(times_shared, times_visited, lecture_id) VALUES (15, 15, 4);

insert into lecture(status, type, created_at, starts_at, ends_at, organizer_id, address, description, lecturer, title, url) values ('SCHEDULED', 'ONLINE', utc_timestamp, '2024-11-01 03:00:00', '2024-11-06 23:00:00', 1, null, 'Email Online', 'Sunny da Silva', 'Palestra de física', 'https://teste.com');
insert into metrics(times_shared, times_visited, lecture_id) VALUES (11, 23, 5);

insert into lecture(status, type, created_at, starts_at, ends_at, organizer_id, address, description, lecturer, title, url) values ('SCHEDULED', 'PRESENTIAL', utc_timestamp, '2024-11-01 03:00:00', '2024-11-06 23:00:00', 1, 'rua pingola da silva', 'Email Presencial', 'Taylor da Silva', 'Palestra de artes', 'https://teste.com');
insert into metrics(times_shared, times_visited, lecture_id) VALUES (53, 100, 6);

insert into lecture(status, type, created_at, starts_at, ends_at, organizer_id, address, description, lecturer, title, url) values ('SCHEDULED', 'HYBRID', utc_timestamp, '2024-11-01 03:00:00', '2024-11-06 23:00:00', 1, 'rua pingola da silva', 'Email Hybrid', 'Julien da Silva', 'Palestra de espanhol', 'https://teste.com');
insert into metrics(times_shared, times_visited, lecture_id) VALUES (10, 10, 7);

insert into lecture(status, type, created_at, starts_at, ends_at, organizer_id, address, description, lecturer, title, url) values ('SCHEDULED', 'HYBRID', utc_timestamp, '2024-11-01 03:00:00', '2024-11-06 23:00:00', 1, 'rua pingola da silva', 'Email Hybrid', 'Shang da Silva', 'Palestra de espanhol', 'https://teste.com');
...
INSERT INTO lecture_tags(lecture_id, category_tag_id) VALUES (1, 1), (1, 2), (1, 3), (2,1), (2,4);
